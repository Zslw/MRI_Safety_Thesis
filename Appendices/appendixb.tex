...
\invisiblesection{Appendix B1: Copyright License – Figure \ref{fig:lead-fixation-design}}
\label{app:B1}

\includepdf[pages={1,2}]{Licenses/RightsLink Printable License-Epileadsfigures.pdf}


\invisiblesection{Appendix B2: Copyright License – Figure \ref{fig:astm_diagram}}
\label{app:B2}

\includepdf[pages={1,2}]{Licenses/ASTMF2052 License.pdf}