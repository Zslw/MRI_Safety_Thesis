\begin{titlepage}
    ...
    \end{center}
		...
		Date \hspace{8cm} Michael G. Nichols, Ph.D., Chair
		\vspace{1.5cm}\\
        \null \hspace{9cm} \line(1,0){200} \\	
		\null \hspace{9cm} Jonathan P. Wrubel, Ph.D.
        \vspace{1.5cm}\\
		\null \hspace{9cm} \line(1,0){200} \\	
		\null \hspace{9cm} Brian Hill, MS., DABR
        \vspace{2.5cm}\\
		\null \hspace{9cm} \line(1,0){200} \\	
		\null \hspace{9cm} A. Barron Breland, D.M. \\
		\null \hspace{9cm} Dean, Graduate School
