...
\chapter{Engineering Drawings} \label{sec:appa}% Input Appendix titles as chapters.  \label{sec:appa} is a section label, which makes it easy to reference the section with the command \ref{sec:appa}
\input{Appendices/engineering_Draws}
%\clearpage

\chapter{Sample calculations}
\input{Appendices/sample_calculations}

\chapter{Calibration Logs}\label{sec:appb}% and Supplementary Graphs} \label{sec:appb}
