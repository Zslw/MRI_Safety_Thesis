...
\usetikzlibrary{shapes.geometric, arrows,positioning} % only the libs you need
...
\begin{tikzpicture}[node distance=1.5cm, every node/.style={transform shape}, scale=0.6]
	...
	% Mode decision
	\node (mode) [decision, below of=clearbuf, yshift=-1.5cm] {Data collection mode?};
	...
	% Loop decision
	\node (moreRuns) [decision, below of=delayWait, yshift=-1.5cm] {More runs/points?};
