...
\begin{table}[hbt!]
	\centering
	\caption[Summary of the sensor and circuit parameters used for force and torque resolution estimation.]{Summary of the sensor and circuit parameters used for force and torque resolution estimation. Values are set for an aluminum-based sensor, paired with the circuit explained in Section \ref{sec:circuitDesignNsensor}}
